...
if [ -n "$selected_wall" ]; then
    ...
    matugen image "$IMAGE" -m dark -t scheme-expressive --prefer saturation --contrast 0.5
    #matugen image "$IMAGE" -m dark -t scheme-fidelity --prefer saturation --contrast 0.5
