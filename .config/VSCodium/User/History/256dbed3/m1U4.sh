...
if [ -n "$selected_wall" ]; then
    ...
    #matugen image "$IMAGE" -m dark -t scheme-rainbow --prefer saturation
    #matugen image "$IMAGE" -m dark -t scheme-vibrant --prefer saturation
    matugen image "$IMAGE" -m dark -t scheme-fidelity --prefer saturation --source-color-index 0 --contrast 0.1 --lightness-dark -0.05
